...
RUN mkdir -p ${ORACLE_HOME}/libs && \
    ...
    curl -L -u "${ARTIFACTORY_USERNAME}:${ARTIFACTORY_PASSWORD}" ${ARTIFACTORY_BASE_URL}/uk/gov/companieshouse/compliance-trigger/2.0.0/compliance-trigger-2.0.0.jar -o ../compliance-trigger/compliance-trigger.jar && \
